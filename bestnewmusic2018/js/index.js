...
var spotLight = new THREE.SpotLight(0xEF07F3);
...
function Mat(){
  var material = new THREE.MeshPhongMaterial({
    color      : new THREE.Color("rgb(255,255,255)"),  //Diffuse color of the material
    emissive   : new THREE.Color("rgb(255,99,89)"), //Emissive(light) color of the material, essentially a solid color unaffected by other lighting. Default is black.
    specular   : new THREE.Color("rgb(299,99,95)"), /*Specular color of the material, i.e., how shiny the material is and the color of its shine.
...
/* Create Geometry */
var geometry = new THREE.SphereGeometry(70,20,20,0,Math.PI*2,0,Math.PI);
//SphereGeometry(radius, widthSegments, heightSegments, phiStart, phiLength, thetaStart, thetaLength)

/* Create Earth Sphere*/
var earth = new THREE.Mesh(geometry, Mat());
// earth.translateX(100);
...
$(window).scroll(function(){
  var newOpacity = Math.max((1 - ($(window).scrollTop() / 250)), 0.3);
