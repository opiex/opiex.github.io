        ...
        init: function(_options) {
            ...
            return this.each(function() {
                ...
                if (!data) {
                    ...
                    console.log(options.svgData.guru);
                    var w = options.svgData.guru.dimensions.width;
                    var h = options.svgData.guru.dimensions.height;

                    // target stroke path
                    options.svgData = options.svgData.guru.strokepath;
